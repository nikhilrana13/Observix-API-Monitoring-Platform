        ...
        <div className="w-full max-w-md  relative">
          <div className="bg-[#211e29]/80 backdrop-blur border border-[#5b13ec1a] rounded-xl p-8 md:p-10 flex flex-col gap-8 shadow-[0_0_40px_-10px_rgba(91,19,236,0.2)]">
            ...
            <form className="space-y-6">
              ...
              <button className="w-full bg-[#5b13ec] hover:bg-[#662bf7] text-white font-semibold py-3.5 rounded-lg transition flex items-center justify-center gap-2 shadow-lg shadow-[#5b13ec]/20">
                Log In →
              </button>
            </form>
